...
public class Elevator extends SubsystemBase {
    ...
    public void raise(double distance) {
        ...
        this.move(MathUtil.clamp(pidController.calculate(distance), -Constants.Elevator.maxMotorSpeed,
    ...
    private void updatePosition() {
        currentPosition = (elevatorMotorLeft.getEncoder().getPosition() + elevatorMotorRight.getEncoder().getPosition())
                / 2;
    }
