...
public class IntakeCmd extends CommandBase {
    ...
    public void execute(){
        if(cone && intake){
            s_Intake.setIntakeMotor(-Constants.IntakeConstants.coneIntakeSpeed);
        }
        if(!cone && intake){
            s_Intake.setIntakeMotor(Constants.IntakeConstants.cubeIntakeSpeed);
        }
        if(cone && !intake){
            s_Intake.setIntakeMotor(Constants.IntakeConstants.coneIntakeSpeed);
        }
