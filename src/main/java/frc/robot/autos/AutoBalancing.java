...
public class AutoBalancing extends CommandBase {
    ...
    public void execute() {
        ...
        double translationVal = MathUtil.clamp(
                pidController.calculate(
                        s_Swerve.getPitch().getDegrees(), Constants.Swerve.pitchSetPoint),
                -.35, .35);
        s_Swerve.drive(
    ...
    public void end(boolean interrupted) {
        ...
        // modules[0].setDesiredState(new SwerveModuleState(0,
        // Rotation2d.fromDegrees(45.0), true);
        // modules[1].setDesiredState(new SwerveModuleState(0,
        // Rotation2d.fromDegrees(315.0), true);
        // modules[2].setDesiredState(new SwerveModuleState(0,
        // Rotation2d.fromDegrees(315.0), true);
        // modules[3].setDesiredState(new SwerveModuleState(0,
        // Rotation2d.fromDegrees(45.0), true);
    }
